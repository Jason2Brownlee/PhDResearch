...
{   
    ...
    protected void notifyListeners(Problem p, LinkedList<Solution> pop, Solution best)
    {
        for(AlgorithmIterationNotification n : listeners)
        {
            n.iterationComplete(p, pop, best);
        }
    }
     ...
     * @return
     */
    public abstract Solution executeAlgorithm(Problem aProblem);
