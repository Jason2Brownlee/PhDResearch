...
public class PopulationAlgorithmUtils
{
    ...
    public static void fixCoordBounds(double [] coord, Problem p)
    {
        if(p.isToroidal())
        {
            wrapCoord(coord, p);
     ...
     * @param p
     */
    private static void wrapCoord(double [] coord, Problem p)
    {
     ...
     * @param p
     */
    private static void reflectCoord(double [] coord, Problem p)
    {
        double [][] minmax = p.getMinmax();        
