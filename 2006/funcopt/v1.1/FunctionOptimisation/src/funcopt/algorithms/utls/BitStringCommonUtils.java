...
//    public static double stringToDouble(boolean [] a, double min, double max)
//    {
//        double sum = 0.0;
//        for (int j = 0; j < a.length-1; j++)
//        {
//            sum += ((a[j]) ? 1 : 0) - j * Math.pow(2.0, j);
//        }
//        return min + ((max-min) / (Math.pow(2,a.length)-1)) * sum;
//    }
	...
	{
//        boolean [] testBits = new boolean[]{true,true,true};
//        System.out.println(stringToDouble(testBits, ));
