 ...
 * </pre>
 */
public class RecirculationMainFrame extends ExplorerFrame
{
    public RecirculationMainFrame()
    {
    	super(new RecirculationDomain());
    }
    
    public static void main(String[] args)
    {
        new RecirculationMainFrame().makeVisible();
    }
}
