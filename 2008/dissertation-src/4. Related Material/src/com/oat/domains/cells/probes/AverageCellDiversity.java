 ...
 * </pre>
 */
public class AverageCellDiversity extends GenericEpochCompletedProbe
{
	...
	{	
		if(algorithm != null)
		{
			diversity = CellUtils.averageDistance(algorithm.getRepertoire());
		}
	}
	...
	{
		return "Average Cell Diversity (ACD)";
	}
}
