 ...
 * </pre>
 */
public class CellSetAverageHammingError extends GenericEpochCompletedProbe
{
	...
	{	
		...
		{
			errors[i] = antigen[i].costCellHamming(cells[i]);
		}
	...
	{
		return "Cell Set Average Hamming Error (CSAHE)";
	}
}
