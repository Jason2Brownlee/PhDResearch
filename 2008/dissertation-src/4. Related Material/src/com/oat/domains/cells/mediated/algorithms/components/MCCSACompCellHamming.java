 ...
 * </pre>
 */
public class MCCSACompCellHamming extends MCCSACompCellEuclidean
{
	@Override
	...
	{
		// hamming distance
		MediatedUtils.assessRepertoireAgainstComponentRepertoireHamming(tCellSet, bCellSet, component);
	}	
	...
	{
		return "MCCSA Comp-to-Cell (Hamming)";
	}
}
