 ...
 * </pre>
 */
public class AverageTCellDiversity extends GenericEpochCompletedProbe
{
	...
	{	
		if(algorithm != null)
		{
			diversity = CellUtils.averageDistance(algorithm.getTCells());
		}
	}
	...
	{
		return "Average T-Cell Diversity (ATCD)";
	}
}
