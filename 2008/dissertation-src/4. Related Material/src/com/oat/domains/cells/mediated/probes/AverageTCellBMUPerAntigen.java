 ...
 * </pre>
 */
public class AverageTCellBMUPerAntigen extends GenericEpochCompletedProbe
{
	...
	{	
		if(algorithm != null)
		{
			LinkedList<Cell> repertoire = algorithm.getTCells();		
	...
	{
		return "Average T-Cell BMU Per Antigen (ATC-BMU/Antigen)";
	}
}
