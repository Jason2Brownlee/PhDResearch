 ...
 * </pre>
 */
public class CellularStudy1 extends ClonalSelectionTemplateExperiment
{
	public static void main(String[] args)
	{
		new CellularStudy1().run();
	}
	...
	public LinkedList<ExperimentalRun> createRunList()
	{
		...
		// algorithms
		matrix.addAlgorithm(new CCSA1_1());
		matrix.addAlgorithm(new CCSA1_N());
		matrix.addAlgorithm(new CCSAN_1());
		matrix.addAlgorithm(new CCSAN_N());
