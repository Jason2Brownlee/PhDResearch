 ...
 * </pre>
 */
public class CellSetAbsoluteEuclideanError extends GenericEpochCompletedProbe
{
	...
	{	
		...
		{
			err += antigen[i].costCell(cells[i]);
		}
	...
	{
		return "Cell Set Absolute Eucldiean Error (CSAbEE)";
	}
}
