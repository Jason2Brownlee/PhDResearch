 ...
 * </pre>
 */
public class AverageMappedBMUEuclideanError extends GenericEpochCompletedProbe implements NetworkInteractionListener
{
			...
			C bmu2)
	{
		...
		{
			sumEuclideanError += CellUtils.euclideanDistance((Cell)antigen2, (Cell)bmu2);
		}
		else
		{
			// network cell goes in second on this method
			sumEuclideanError += NetworkUtils.euclideanDistanceAgainstMapping((Cell)bmu2, (NetworkCell)antigen2);
		}		
		numPairs++;		
	}
	...
	{
		return "Average Mapped BMU Euclidean Error (AMBMUEE)";
	}
}
