 ...
 * </pre>
 */
public class AverageNetworkCellDiversity extends GenericEpochCompletedProbe
{
	...
	{	
		if(algorithm != null)
		{
			...
			if(repertoire != null)
			{
				diversity = NetworkUtils.averageNetworkCellHammingDistance(repertoire);
			}
		}
	}
	...
	{
		return "Average Network Cell Diversity (ANCD)";
	}
}
