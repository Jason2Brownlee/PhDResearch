 ...
 * </pre>
 */
public class AverageBCellBMUPerAntigen extends GenericEpochCompletedProbe
{
    ...
    public void initialiseBeforeRunInternal(Problem p, Algorithm a) throws InitialisationException
	{
		...
		{			
			if(((MediatedCellularAlgorithm)a).isCellBased())
			{
	...
	{	
		if(algorithm != null)
		{
			LinkedList<Cell> repertoire = algorithm.getBCells();		
	...
	{
		return "Average B-Cell BMU Per Antigen (ABC-BMU/Antigen)";
	}
}
