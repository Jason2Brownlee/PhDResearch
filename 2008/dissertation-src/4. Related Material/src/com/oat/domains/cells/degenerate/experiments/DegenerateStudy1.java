 ...
 * </pre>
 */
public class DegenerateStudy1 extends ClonalSelectionTemplateExperiment
{
	public static void main(String[] args)
	{
		new DegenerateStudy1().run();
	}
	...
	public LinkedList<ExperimentalRun> createRunList()
	{
		...
		// algorithms
		matrix.addAlgorithm(new DSCCSA_Probabilistic());
		matrix.addAlgorithm(new DSCCSA_Deterministic());		
