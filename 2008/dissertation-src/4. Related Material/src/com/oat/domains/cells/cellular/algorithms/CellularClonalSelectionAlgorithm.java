 ...
 * </pre>
 */
public class CellularClonalSelectionAlgorithm extends GenericCellularClonalSelectionAlgorithm<Cell>
{
	// config
	...
	{		
		...
		LinkedList<Cell> selected = CellUtils.selectCellSet(cells, rand, numSelected);	
		
		// process the selected set individually
		for(Cell selectedCell : selected)
		{
			// cloning and mutation
			LinkedList<Cell> clones = CellUtils.cloningAndMutationCell(selectedCell, numClones, rand);
	...
	{
		return "Cellular Clonal Selection Algorithm (CCSA)";
	}
