...
Project Lead
*/
package com.oat.domains.cells.network.algorithms.proxy.bmu2;
 ...
 * </pre>
 */
public class PNCCSA_C_SP extends PNCCSA
{
	@Override
	protected void respondFirstBMU(Antigen antigen, NetworkCell bmu1, NetworkCell bmu2)
	{
		...
		// assess secondary against bmu2
		NetworkUtils.assessMappedRepertoireAgainstCellEuclidean(cells, bmu2);
		NetworkUtils.assessMappedRepertoireAgainstCellEuclidean(clones, bmu2);	
		// replace based on secondary string
