 ...
 * </pre>
 */
public class CellSetAbsoluteHammingError extends GenericEpochCompletedProbe
{
	...
	{	
		...
		{
			err += antigen[i].costCellHamming(cells[i]);
		}
	...
	{
		return "Cell Set Absolute Hamming Error (CSAbHE)";
	}
}
