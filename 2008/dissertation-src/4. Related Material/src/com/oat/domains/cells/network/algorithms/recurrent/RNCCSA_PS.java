 ...
 * </pre>
 */
public class RNCCSA_PS extends RNCCSA
{
	@Override
	protected NetworkCell exposureAntigen(Antigen trigger)
	{
		...
		// assess primary
		CellUtils.assessRepertoireAgainstAntigen(trigger, clones);
		// replace primary
	...
	protected NetworkCell exposureCell(NetworkCell trigger)
	{
		...
		LinkedList<NetworkCell> clones = NetworkUtils.cloningAndMutationNetwork(selectedSet, numClones, rand);
		// assess secondary
		NetworkUtils.assessMappedRepertoireAgainstCellMappingEuclidean(clones, trigger);
		// replace secondary
