 ...
 * </pre>
 */
public class SpatialStudy2 extends ClonalSelectionTemplateExperiment
{
	public static void main(String[] args)
	{
		new SpatialStudy2().run();
	}
	...
	public LinkedList<ExperimentalRun> createRunList()
	{
		...
		// algorithms
		matrix.addAlgorithm(new SCCSA_Component());
		matrix.addAlgorithm(new SCCSA_TopDown());
		matrix.addAlgorithm(new SCCSA_BottomUp());
	...
	public LinkedList<RunProbe> getReportingStatistics()
	{
		...
		reportStats.add(new AverageSubCellNeighbourhoodDiversity());
