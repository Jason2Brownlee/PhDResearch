 ...
 * </pre>
 */
public class CCSANNGrouped extends CellularClonalSelectionAlgorithm
{
	public CCSANNGrouped()
	{
		numCells = 60; 
		numSelected = 2; 
		numClones = 3; 
	...
	{		
		...
		clones = CellUtils.selectCellSet(clones, rand, numSelected);	
