 ...
 * </pre>
 */
public class DE_NCCSA_PSSP extends DE_NCCSA
{
	@Override
	protected NetworkCell primaryExposure(Antigen primaryAntigen, Antigen secondaryAntigen)
	{
		...
		CellUtils.assessRepertoireAgainstAntigen(primaryAntigen, clones);
	...
	protected NetworkCell secondaryExposure(Antigen primaryAntigen, Antigen secondaryAntigen)
	{
		...
		NetworkUtils.assessMappedRepertoireAgainstAntigen(secondaryAntigen, clones);		
