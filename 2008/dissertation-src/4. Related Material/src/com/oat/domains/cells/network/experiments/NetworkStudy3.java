 ...
 * </pre>
 */
public class NetworkStudy3 extends ClonalSelectionTemplateExperiment
{
	public static void main(String[] args)
	{
		new NetworkStudy3().run();
	}
	...
	public LinkedList<ExperimentalRun> createRunList()
	{
		...
		// algorithms
		matrix.addAlgorithm(new PNCCSA_A_PP());
		matrix.addAlgorithm(new PNCCSA_A_PS());
		matrix.addAlgorithm(new PNCCSA_A_SP());
		matrix.addAlgorithm(new PNCCSA_A_SS());		
		// other ones
		matrix.addAlgorithm(new PNCCSA_C_SP());
		matrix.addAlgorithm(new PNCCSA_C_SS());
	...
	public LinkedList<RunProbe> getReportingStatistics()
	{
		...
		// system composition and capability		
