 ...
 * </pre>
 */
public class AverageCellDiversityRatio extends GenericEpochCompletedProbe
{
	...
	{	
		if(algorithm != null)
		{
			diversity = CellUtils.averageDistanceRatio(algorithm.getRepertoire());
		}
	}
	...
	{
		return "Average Cell Diversity Ratio (ACDR)";
	}
}
