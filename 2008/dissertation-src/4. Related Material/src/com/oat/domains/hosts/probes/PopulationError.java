 ...
 * </pre>
 */
public class PopulationError extends GenericEpochCompletedProbe
{
	...
	{	
		...
		Habitat [] habitats = ((HabitatProblem)p).getHabitats();
		
		double [] errors = new double[cells.length];		
		for (int i = 0; i < habitats.length; i++)
		{	
			errors[i] = habitats[i].costCell(cells[i]);
		}
