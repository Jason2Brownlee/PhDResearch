...
Project Lead
*/
package com.oat.domains.hosts.generation.maternal;
...
import com.oat.domains.hosts.generation.maternal.algorithms.MaternalImmunityHostClonalSelectionAlgorithm;
import com.oat.domains.hosts.generation.maternal.algorithms.MinimalGenerationalHostClonalSelectionAlgorithm;
import com.oat.domains.hosts.generation.maternal.gui.MaternalMasterPanel;
 ...
 * </pre>
 */
public class MaternalDomain extends ClonalSelectionDomain
{
	@Override
	public MasterPanel getExplorerPanel()
	{
		return new MaternalMasterPanel(this);
	}

	@Override
	public String getHumanReadableName()
	{
		return "Hosts Maternal Immunity";
	}

	@Override
	public String getShortName()
	{
		return "maternal immunity";
	}
	...
	public Algorithm[] loadAlgorithmList() throws Exception
	{
		return new Algorithm[]		                  
				...
				new MaternalImmunityHostClonalSelectionAlgorithm(),
