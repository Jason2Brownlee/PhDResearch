 ...
 */
public class TestingStimulation extends StimulationStrategy
{
    ...
    {
        return super.getBase() + ".testing";
    }    
    public void loadConfig(String aBase, Properties prop)
    {
        super.loadConfig(aBase, prop);
        String b = aBase + super.getBase() + ".testing";
    ...
    protected LinkedList<Instance> preaprePatternList()
    {
        ...
        while(list.size() < numPatterns && 
                list.size()<testing.numInstances())
        {
            int selection = rand.nextInt(testing.numInstances());
            list.add(testing.instance(selection));
        }
        return list;
    }
